...
<div class="container topmargin-sm clearfix center">
	<div class="col-sm-6 bottommargin-sm">
		...
		<div class="row">
			<a href="{!! url('/' . getLang()) !!}/hand-quilting/z44-frame/" class="button button-rounded button-secondary button-small">See More</a>
			Or
			<a href="{!! url('/' . getLang()) !!}" class="button button-rounded button-small">Buy Now</a>
		</div>
	</div>
	<div class="col-sm-6 bottommargin-sm">
		...
		<div class="row">
			<a href="{!! url('/' . getLang()) !!}/hand-quilting/start-right-ez3/" class="button button-rounded button-secondary button-small">See More</a>
			Or
			<a href="{!! url('/' . getLang()) !!}" class="button button-rounded button-small">Buy Now</a>
		</div>
	</div>
