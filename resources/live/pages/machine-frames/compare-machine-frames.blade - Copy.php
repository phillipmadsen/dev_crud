    ...
    <div id="page-menu-wrap">
        <div class="container clearfix ">
            <nav class="one-page-menu">
                <ul>
                    <li><a href="{!! url('/' . getLang()) !!}/machine-frames/">Machine Quilting</a></li>
                    <li><a class="current" href="{!! URL::full(); !!}"><div>GQ Frame</div></a></li>
                    <li><a href="{!! url('/' . getLang()) !!}/machine-frames/gracie-king/"><div>Gracie King &amp; Queen</div></a></li>
                    <li><a href="{!! url('/' . getLang()) !!}/machine-frames/sr-2-frame"><div>SR-2 Frame</div></a></li>
                    <li><a href="{!! url('/' . getLang()) !!}/machine-frames/accessories/"><div>Accessories</div></a></li>
                    <li><a href="{!! url('/' . getLang()) !!}/machine-frames/compare-machine-frames/"><div>Compare Frames</div></a></li>
                </ul>
            </nav>
      ...
      <div class="container clearfix">
        ...
        <div class="row topmargin-sm clearfix">
          <div class="col_one_fourth compare">
            ...
            <a href="{!! url('/' . getLang()) !!}/machine-frames/gq-frame/" class="button button-rounded button-secondary">Learn More</a>
          </div>
          <div class="col_one_fourth compare">
            <div class="heading-block nobottomborder" style="margin-bottom: 15px;">
              <h5>Gracie King</h5>
            ...
            <a href="{!! url('/' . getLang()) !!}/machine-frames/gracie-king/" class="button button-rounded button-secondary">Learn More</a>
          </div>
          <div class="col_one_fourth compare">
            <div class="heading-block nobottomborder" style="margin-bottom: 15px;">
              <h5>Gracie Queen</h5>
            ...
            <a href="{!! url('/' . getLang()) !!}/machine-frames/gracie-queen/" class="button button-rounded button-secondary">Learn More</a>
          </div>
          <div class="col_one_fourth compare col_last">
            ...
            <a href="{!! url('/' . getLang()) !!}/machine-frames/sr-2-frame/" class="button button-rounded button-secondary">Learn More</a>
          </div>
        </div>
      </div>
    </div>
