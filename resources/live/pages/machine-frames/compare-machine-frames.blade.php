...
<section id="page-title">
    <div class="container clearfix">
        ...
        <li class="breadcrumb-lead"><a title="Go Home." href="{!! url('/' . getLang()) !!}/" itemprop="url"><span itemprop="title">Home</span></a></li>
          ...
          <a title="Go to Machine Quilting." href="{!! url('/' . getLang()) !!}/machine-frames/" itemprop="url"><span itemprop="title">Machine Quilting </span></a></li>
          ...
          <div class="table-responsive">
              <table class="table table-hover table-comparison nobottommargin">
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="">&nbsp;</td>
                    <td><a href="{!! url('/' . getLang()) !!}/machine-frames/gq-frame/" class="button button-rounded button-reveal button-medium button-red tright">Learn More</a></td>
