...
<!--frames ============================-->
<a class="button button-full button-dark center tright bottommargin-sm" href="{!! url('/' . getLang()) !!}/machine-frames/compare-machine-frames/">
    <div class="container clearfix">
...
<div class="container clearfix">
    ...
    <div class="row topmargin-sm clearfix">
        <div class="col_one_third">
         ...
         <a href="{!! url('/' . getLang()) !!}/machine-frames/gq-frame/" class="button button-rounded">Buy Now</a>
 ...
 <div class="row bottommargin-sm center">
    <a href="{!! url('/' . getLang()) !!}/machine-frames/compare-machine-frames/" class="button button-border button-rounded">Compare Frames</a>
</div>
