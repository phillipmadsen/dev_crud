    ...
    <div id="page-menu-wrap">
        <div class="container clearfix ">
            <nav class="one-page-menu">
                <ul>
                   <li><a href="{!! url('/' . getLang()) !!}/automation/qct/">Quilter&#39;s Creative Touch</a></li>
                   <li><a href="{!! url('/' . getLang()) !!}/automation/qct/features/">Feature List</a></li>
                   <li><a href="{!! url('/' . getLang()) !!}/automation/qct/compare/">Compare Versions</a></li>
                   <li><a href="{!! url('/' . getLang()) !!}/automation/qct/specs/">Specs</a></li>
                   <li><a href="{!! url('/' . getLang()) !!}/automation/qct/tutorials/">Tutorials</a></li>
                   <li><a href="{!! url('/' . getLang()) !!}/automation/qct/support/">Support</a></li>
                   <li class="current"><a class="button button-rounded button-border" href="{!! url('/' . getLang()) !!}/automation/qct/purchase/">Get QCT Now</a></li>
               </ul>
           </nav>
