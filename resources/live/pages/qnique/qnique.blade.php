...
<!--page level css -->
 {{-- {!! HTML::style("frontend/custom-css/qnique.css") !!} --}}
 {!! Minify::stylesheet('/frontend/custom-css/qnique.css') !!}
            ...
            <div id="page-menu-wrap">
                <div class="container clearfix ">
                    <nav class="one-page-menu">
                        <ul>
                            <li><a class="current" href="{!! url('/' . getLang()) !!}/qnique/">Qnique Quilter</a></li>
                            <li><a href="{!! url('/' . getLang()) !!}/qnique/features/"><div>Features</div></a></li>
                            <li><a href="{!! url('/' . getLang()) !!}/qnique/specs/"><div>Specs</div></a></li>
                            <li><a href="{!! url('/' . getLang()) !!}/qnique/accessories/"><div>Accessories</div></a></li>
...
<!--expand your reach parallax =================================================== -->
 ...
 <div class="toppadding-sm bottompadding-sm center bgcolor-second dark nobottommargin"> </div>  
<!--Superior Stitching Section ========================================-->

                <div class="section parallax nobottommargin notopmargin dark" style="background-image: url('{!! url('frontend/images/product-overviews/qnique/needle-blue.jpg') !!}');" data-stellar-background-ratio="0.4">
                        ...
                        <div class="row topmargin-sm clearfix">
                         ...
                         <div class="row topmargin-sm clearfix">
                           ...
                           <div class="col_half col_last nobottommargin">
                                <div class="feature-box center media-box fbox-bg">
                                    <div class="fbox-media">                                 
                                        <img class="image_fade" src="{!! url('frontend/images/product-overviews/qnique/accessory-ports.jpg') !!}" 
                                        alt="Featured Box Image" style="opacity: 0.8;"> 
                                    </div>
                                    <div class="fbox-desc">
                                        <div class="heading-block" style="margin-bottom: 15px;">
                                            <h3>Additional Accessory Ports</h3>
